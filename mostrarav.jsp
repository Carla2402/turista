<%-- 
    Document   : mostrarav
    Created on : 21/07/2020, 08:49:33 PM
    Author     : HP
--%>
...
<html>
    ...
    <center><h1>Marcadores Valle de Bravo</h1></center>
         <table border="1">
            <tr>
            ...
            <%
                ...
                executeQuery("select * from archivo2 ");
            while(ra.next()){
                %>
                <tr>
        ...
        <form name="ok" action="valle.jsp" method="post">
